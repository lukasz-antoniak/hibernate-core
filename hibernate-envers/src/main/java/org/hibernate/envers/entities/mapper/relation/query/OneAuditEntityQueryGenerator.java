...
public final class OneAuditEntityQueryGenerator extends AbstractRelationQueryGenerator {
	...
	public OneAuditEntityQueryGenerator(GlobalConfiguration globalCfg, AuditEntitiesConfiguration verEntCfg,
		...
		createValidDataRestrictions(
				globalCfg, verEntCfg, auditStrategy, referencedIdData, validQuery, validQuery.getRootParameters()
		);
	...
	private void createValidAndRemovedDataRestrictions(GlobalConfiguration globalCfg, AuditEntitiesConfiguration verEntCfg,
		...
		createValidDataRestrictions( globalCfg, verEntCfg, auditStrategy, referencedIdData, remQb, valid );
		// e.revision = :revision
