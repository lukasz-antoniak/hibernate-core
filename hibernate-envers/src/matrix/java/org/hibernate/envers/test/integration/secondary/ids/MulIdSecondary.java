...
public class MulIdSecondary extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 2L).equals(getAuditReader().getRevisions(SecondaryMulIdTestEntity.class, id));
    }
    ...
    public void testHistoryOfId() {
        ...
        assert getAuditReader().find(SecondaryMulIdTestEntity.class, id, 1L).equals(ver1);
        assert getAuditReader().find(SecondaryMulIdTestEntity.class, id, 2L).equals(ver2);
    }
