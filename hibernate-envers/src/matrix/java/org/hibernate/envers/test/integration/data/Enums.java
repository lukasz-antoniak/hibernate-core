...
public class Enums extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 2L).equals(getAuditReader().getRevisions(EnumTestEntity.class, id1));
    }
    ...
    public void testHistoryOfId1() {
        ...
        assert getAuditReader().find(EnumTestEntity.class, id1, 1L).equals(ver1);
        assert getAuditReader().find(EnumTestEntity.class, id1, 2L).equals(ver2);
    }
}