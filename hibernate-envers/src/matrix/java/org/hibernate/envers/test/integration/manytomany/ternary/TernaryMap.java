...
public class TernaryMap extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 2L, 4L).equals(getAuditReader().getRevisions(TernaryMapEntity.class, map1_id));
        assert Arrays.asList(1L, 2L, 3L, 4L).equals(getAuditReader().getRevisions(TernaryMapEntity.class, map2_id));
        ...
        assert Arrays.asList(1L).equals(getAuditReader().getRevisions(IntTestEntity.class, int1_id));
        assert Arrays.asList(1L).equals(getAuditReader().getRevisions(IntTestEntity.class, int2_id));
    }
    ...
    public void testHistoryOfMap1() {
        ...
        TernaryMapEntity rev4 = getAuditReader().find(TernaryMapEntity.class, map1_id, 4L);
    ...
    public void testHistoryOfMap2() {
        ...
        TernaryMapEntity rev1 = getAuditReader().find(TernaryMapEntity.class, map2_id, 1L);
        TernaryMapEntity rev2 = getAuditReader().find(TernaryMapEntity.class, map2_id, 2L);
        TernaryMapEntity rev3 = getAuditReader().find(TernaryMapEntity.class, map2_id, 3L);
        TernaryMapEntity rev4 = getAuditReader().find(TernaryMapEntity.class, map2_id, 4L);
