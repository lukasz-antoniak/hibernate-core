...
public class EmbIdBidirectional extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 2L).equals(getAuditReader().getRevisions(BiEmbIdRefEdEntity.class, ed1_id));
        assert Arrays.asList(1L, 2L).equals(getAuditReader().getRevisions(BiEmbIdRefEdEntity.class, ed2_id));

        assert Arrays.asList(1L, 2L).equals(getAuditReader().getRevisions(BiEmbIdRefIngEntity.class, ing1_id));
    }
    ...
    public void testHistoryOfEdId1() {
        ...
        BiEmbIdRefEdEntity rev1 = getAuditReader().find(BiEmbIdRefEdEntity.class, ed1_id, 1L);
        BiEmbIdRefEdEntity rev2 = getAuditReader().find(BiEmbIdRefEdEntity.class, ed1_id, 2L);
    ...
    public void testHistoryOfEdId2() {
        ...
        BiEmbIdRefEdEntity rev1 = getAuditReader().find(BiEmbIdRefEdEntity.class, ed2_id, 1L);
        BiEmbIdRefEdEntity rev2 = getAuditReader().find(BiEmbIdRefEdEntity.class, ed2_id, 2L);
    ...
    public void testHistoryOfIngId1() {
        ...
        BiEmbIdRefIngEntity rev1 = getAuditReader().find(BiEmbIdRefIngEntity.class, ing1_id, 1L);
        BiEmbIdRefIngEntity rev2 = getAuditReader().find(BiEmbIdRefIngEntity.class, ing1_id, 2L);
