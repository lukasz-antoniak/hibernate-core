...
public class NullProperties extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 3L).equals(getAuditReader().getRevisions(BasicTestEntity1.class, id1));

        assert Arrays.asList(2L, 4L).equals(getAuditReader().getRevisions(BasicTestEntity1.class, id2));
    }
    ...
    public void testHistoryOfId2() {
        ...
        assert getAuditReader().find(BasicTestEntity1.class, id2, 4L).equals(ver2);
    }
}