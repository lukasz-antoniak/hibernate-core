...
public class BasicUniMap extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 2L, 3L, 4L).equals(getAuditReader().getRevisions(MapUniEntity.class, coll1_id));
    ...
    public void testHistoryOfColl1() {
        ...
        MapUniEntity rev1 = getAuditReader().find(MapUniEntity.class, coll1_id, 1L);
        MapUniEntity rev2 = getAuditReader().find(MapUniEntity.class, coll1_id, 2L);
        MapUniEntity rev3 = getAuditReader().find(MapUniEntity.class, coll1_id, 3L);
        MapUniEntity rev4 = getAuditReader().find(MapUniEntity.class, coll1_id, 4L);
