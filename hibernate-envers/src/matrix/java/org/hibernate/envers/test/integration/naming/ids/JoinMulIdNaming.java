...
public class JoinMulIdNaming extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 2L).equals(getAuditReader().getRevisions(JoinMulIdNamingRefEdEntity.class, ed_id1));
        assert Arrays.asList(1L, 2L).equals(getAuditReader().getRevisions(JoinMulIdNamingRefEdEntity.class, ed_id2));
        assert Arrays.asList(1L, 2L).equals(getAuditReader().getRevisions(JoinMulIdNamingRefIngEntity.class, ing_id1));
    }
    ...
    public void testHistoryOfEdId1() {
        ...
        assert getAuditReader().find(JoinMulIdNamingRefEdEntity.class, ed_id1, 1L).equals(ver1);
        assert getAuditReader().find(JoinMulIdNamingRefEdEntity.class, ed_id1, 2L).equals(ver1);
    }
    ...
    public void testHistoryOfEdId2() {
        ...
        assert getAuditReader().find(JoinMulIdNamingRefEdEntity.class, ed_id2, 1L).equals(ver1);
        assert getAuditReader().find(JoinMulIdNamingRefEdEntity.class, ed_id2, 2L).equals(ver1);
    }
    ...
    public void testHistoryOfIngId1() {
        ...
        assert getAuditReader().find(JoinMulIdNamingRefIngEntity.class, ing_id1, 1L).equals(ver1);
        assert getAuditReader().find(JoinMulIdNamingRefIngEntity.class, ing_id1, 2L).equals(ver2);

        assert getAuditReader().find(JoinMulIdNamingRefIngEntity.class, ing_id1, 1L).getReference().equals(
                new JoinMulIdNamingRefEdEntity(ed_id1, "data1"));
        assert getAuditReader().find(JoinMulIdNamingRefIngEntity.class, ing_id1, 2L).getReference().equals(
