...
public class BasicDetachedSet extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 2L, 3L, 4L).equals(getAuditReader().getRevisions(SetRefCollEntity.class, coll1_id));
    ...
    public void testHistoryOfColl1() {
        ...
        SetRefCollEntity rev1 = getAuditReader().find(SetRefCollEntity.class, coll1_id, 1L);
        SetRefCollEntity rev2 = getAuditReader().find(SetRefCollEntity.class, coll1_id, 2L);
        SetRefCollEntity rev3 = getAuditReader().find(SetRefCollEntity.class, coll1_id, 3L);
        SetRefCollEntity rev4 = getAuditReader().find(SetRefCollEntity.class, coll1_id, 4L);
