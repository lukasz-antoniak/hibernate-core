...
public class StringList extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 2L, 3L).equals(getAuditReader().getRevisions(StringListEntity.class, sle1_id));
        assert Arrays.asList(1L, 2L, 3L).equals(getAuditReader().getRevisions(StringListEntity.class, sle2_id));
    }

    @Test
    public void testHistoryOfSle1() {
        StringListEntity rev1 = getAuditReader().find(StringListEntity.class, sle1_id, 1L);
        StringListEntity rev2 = getAuditReader().find(StringListEntity.class, sle1_id, 2L);
        StringListEntity rev3 = getAuditReader().find(StringListEntity.class, sle1_id, 3L);
    ...
    public void testHistoryOfSse2() {
        StringListEntity rev1 = getAuditReader().find(StringListEntity.class, sle2_id, 1L);
        StringListEntity rev2 = getAuditReader().find(StringListEntity.class, sle2_id, 2L);
        StringListEntity rev3 = getAuditReader().find(StringListEntity.class, sle2_id, 3L);
