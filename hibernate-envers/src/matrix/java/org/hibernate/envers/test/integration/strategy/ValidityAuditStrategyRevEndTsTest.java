...
public class ValidityAuditStrategyRevEndTsTest extends AbstractEntityTest {
	...
	public void initData() {
		...
		revisionNumbers.addAll(Arrays.asList(1L, 2L, 3L, 4L, 5L));
