...
public class BasicList extends AbstractEntityTest {
    ...
    public void testRevisionsCounts() {
        assert Arrays.asList(1L, 2L, 3L).equals(getAuditReader().getRevisions(ListRefEdEntity.class, ed1_id));
        assert Arrays.asList(1L, 2L, 3L).equals(getAuditReader().getRevisions(ListRefEdEntity.class, ed2_id));

        assert Arrays.asList(1L, 2L).equals(getAuditReader().getRevisions(ListRefIngEntity.class, ing1_id));
        assert Arrays.asList(1L, 3L).equals(getAuditReader().getRevisions(ListRefIngEntity.class, ing2_id));
    }
    @Test
    public void testHistoryOfEdId1() {
        ...
        ListRefEdEntity rev1 = getAuditReader().find(ListRefEdEntity.class, ed1_id, 1L);
        ListRefEdEntity rev2 = getAuditReader().find(ListRefEdEntity.class, ed1_id, 2L);
        ListRefEdEntity rev3 = getAuditReader().find(ListRefEdEntity.class, ed1_id, 3L);
    ...
    public void testHistoryOfEdId2() {
        ...
        ListRefEdEntity rev1 = getAuditReader().find(ListRefEdEntity.class, ed2_id, 1L);
        ListRefEdEntity rev2 = getAuditReader().find(ListRefEdEntity.class, ed2_id, 2L);
        ListRefEdEntity rev3 = getAuditReader().find(ListRefEdEntity.class, ed2_id, 3L);
    ...
    public void testHistoryOfEdIng1() {
        ...
        ListRefIngEntity rev1 = getAuditReader().find(ListRefIngEntity.class, ing1_id, 1L);
        ListRefIngEntity rev2 = getAuditReader().find(ListRefIngEntity.class, ing1_id, 2L);
        ListRefIngEntity rev3 = getAuditReader().find(ListRefIngEntity.class, ing1_id, 3L);
    ...
    public void testHistoryOfEdIng2() {
        ...
        ListRefIngEntity rev1 = getAuditReader().find(ListRefIngEntity.class, ing2_id, 1L);
        ListRefIngEntity rev2 = getAuditReader().find(ListRefIngEntity.class, ing2_id, 2L);
        ListRefIngEntity rev3 = getAuditReader().find(ListRefIngEntity.class, ing2_id, 3L);
